...
*/
$autoload['libraries'] = array('sms', 'service', 'upload_conf','upload', 'xingeApp');
...
*/
$autoload['helper'] = array('hex_string', 'url', 'file', 'security', 'cookie', 'random', 'random_number', 'rand_uniqid_helper', 'greeting', 'cut_str', 'chang_image_size', 'log', 'delete_html', 'get_lang_type_helper', 'upload_img_file', 'static_url', 'words_filter', 'move_upload_file', 'get_order_sn', 'get_location_by_lat_lng', 'get_stay_time', 'json_en', 'multi_array_sort', 'get_week', 'push_xingeapp', 'tran_time', 'get_residual_mileage', 'get_lat_lng_by_location', 'string_secret', 'secret_string', 'get_first_charter');
...
*/
$autoload['model'] = array('common_model', 'waybill_model','logic_model','ranking_model');
