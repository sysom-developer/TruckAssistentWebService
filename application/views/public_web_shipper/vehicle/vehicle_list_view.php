...
$(function() {
    ...
    $('.del-vehicle-btn').click(function() {
        ...
        $('.del-vehicle-confirm[driver_id='+driver_id+']').show();
    });
    // 确定删除
    ...
    $('.cancel-del-vehicle-confirm').click(function() {
        ...
        $('.del-vehicle-confirm[driver_id='+driver_id+']').hide();
    });
});
</script>
...
<div class="container">
    ...
    <?php $this->load->view($this->appfolder.'/vehicle/all_vehicle_map_view')?>
        ...
        <ul class="<?php echo $ul_class?>">
            <li id="carer" >
                <a href="<?php echo $data['driver_head_icon_http_file']?>" target="_blank">
                    ...
                    <span><?php echo $data['driver_name']?></span>
                </a>
            </li> 
            <li style="display:table;height:60px;table-layout:fixed; word-break:break-all; word-wrap:break-word"><span style="display:table-cell;vertical-align: middle;"><?php echo $data['driver_mobile']?></span></li> 
            <li style="display:table;height:60px;table-layout:fixed; word-break:break-all; word-wrap:break-word"><span style="display:table-cell;vertical-align: middle;"><?php echo isset($data['vehicle_card_num']) ? $data['vehicle_card_num']: ''?></span></li> 
            ...
            <li style="display:table;height:60px;table-layout:fixed; word-break:break-all; word-wrap:break-word"><span style="display:table-cell;vertical-align: middle;"><?php echo date('Y-m-d', $data['create_time'])?></span></li> 
            <li id="oper">
                ...
                <span class="oper_del del-vehicle-btn" driver_id="<?php echo $data['driver_id']?>"><img src="<?php echo static_url('static/images/'.$this->appfolder.'/del.png')?>" ></span>
                <div class="del_layer del-vehicle-confirm" driver_id="<?php echo $data['driver_id']?>">
                    <input type="submit" class="confirm ok-del-vehicle-confirm" value="确定" driver_id="<?php echo $data['driver_id']?>" driver_id="<?php echo $data['driver_id']?>">
                    <input type="button" class="delcancel cancel-del-vehicle-confirm" value="取消" driver_id="<?php echo $data['driver_id']?>">
                </div>
            </li> 
        </ul>
        <?php
