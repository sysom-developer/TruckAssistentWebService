...
<div class="content">
    ...
    <form action="<?php echo site_url(''.$this->appfolder.'/driver/act_add_data')?>" method="post" enctype="multipart/form-data">
    <div class="forms_box">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td>司机姓名：</td>
                <td>
                    <input type="text" class="txt" name="driver_name" value="">
                </td>
            </tr>
            <tr>
                <td>登陆名：</td>
            ...
            <tr>
                <td>呢称：</td>
                <td>
                    <input type="text" class="txt" name="driver_nick_name" value="">
                </td>
            </tr>
            <tr>
                <td>性别：</td>
            ...
            <tr>
                <td>签名：</td>
                <td>
                    <input type="text" class="txt" name="driver_signature" value="">
                </td>
            </tr>
            <tr>
                <td>所在城市</td>
            ...
            <tr>
                <td>手机号码：</td>
                <td>
                    <input type="text" class="txt" name="driver_mobile" value="">
                </td>
            </tr>
            <tr>
                <td>其他电话：</td>
                <td>
                    <input type="text" class="txt" name="driver_tel" value="">
                </td>
            </tr>
            <tr>
                <td>身份证号码：</td>
                <td>
                    <input type="txt" class="txt" id="driver_card_num" name="driver_card_num">
                </td>
            </tr>
            <tr>
                <td>驾驶证号码：</td>
                <td>
                    <input type="txt" class="txt" id="driver_license" name="driver_license">
                </td>
            </tr>
            <tr>
                <td>头像照片：</td>
            ...
            <tr>
                <td>当前积分：</td>
                <td><input type="text" class="txt" name="driver_score" value="0"></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>
