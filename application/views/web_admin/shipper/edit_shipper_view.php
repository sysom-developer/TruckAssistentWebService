...
<div class="content">
    ...
    <form action="<?php echo site_url(''.$this->appfolder.'/shipper/act_edit_data')?>" method="post" enctype="multipart/form-data">
    ...
    <div class="forms_box">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td>
                    <select name="company_id">
                        ...
                        ?>
                        <option value="<?php echo $value['id']?>" <?php if ($value['id'] == $data['company_id']) { echo 'selected';}?>><?php echo $value['shipper_company_name']?></option>
                        <?php
                        }
                        ?>
                    </select>
            ...
            <tr>
                <td>货主名称：</td>
                <td>
                    <input type="text" class="txt" name="shipper_name" value="<?php echo $data['shipper_name']?>">
                </td>
            </tr>
            <tr>
                <td>货主后台登陆用户名：</td>
            ...
            <tr>
                <td>货主电话：</td>
                <td>
                    <input type="text" class="txt" name="shipper_mobile" value="<?php echo $data['shipper_mobile']?>">
                </td>
            </tr>
            <tr>
                <td>货主身份证号：</td>
                <td>
                    <input type="text" class="txt" name="shipper_card_num" value="<?php echo $data['shipper_card_num']?>">
                </td>
            </tr>
            <tr>
                <td>货主类型</td>
                <td>
                    <select name="shipper_type">
                        <option value="1" <?php if ($data['shipper_type'] == 1) { echo 'selected';}?>>货主</option>
                        <option value="2" <?php if ($data['shipper_type'] == 2) { echo 'selected';}?>>中介</option>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select name="is_admin">
                        <option value="0" <?php if ($data['is_admin'] == 0) { echo 'selected';}?>>不是</option>
                        <option value="1" <?php if ($data['is_admin'] == 1) { echo 'selected';}?>>是</option>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <span>
                        <a href="<?php echo $data['shipper_head_icon_http_file']?>" target="_blank">
                            <img style="padding: 5px;" src="<?php echo $data['shipper_head_icon_http_file']?>" width="100" height="100">
                        </a>
                    </span>
                    <?php }?>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span>
                        <a href="<?php echo $data['shipper_pic_http_file']?>" target="_blank">
                            <img style="padding: 5px;" src="<?php echo $data['shipper_pic_http_file']?>" width="100" height="100">
                        </a>
                    </span>
                    <?php }?>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span>
                        <a href="<?php echo $data['shipper_card_pic_http_file']?>" target="_blank">
                            <img style="padding: 5px;" src="<?php echo $data['shipper_card_pic_http_file']?>" width="100" height="100">
                        </a>
                    </span>
                    <?php }?>
                </td>
            ...
            <tr>
                ...
                <td>
                    <select name="shipper_status" style="width: auto;">
                        <option value="1" <?php if ($data['shipper_status'] == 1) { echo 'selected';}?>>有效</option>
                        <option value="2" <?php if ($data['shipper_status'] == 2) { echo 'selected';}?>>无效</option>
                    </select>
                </td>
            </tr>
            <tr>
