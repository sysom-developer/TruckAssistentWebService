...
<div class="content">
    ...
    <form action="<?php echo site_url(''.$this->appfolder.'/user_dispatch/act_edit_data')?>" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo $id?>">
    <div class="forms_box">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td width="100">用户名：</td>
                <td><input type="text" class="txt" name="username" value="<?php echo $data['username']?>"></td>
            </tr>
            <tr>
                <td>手机号码：</td>
                <td><input type="text" class="txt" name="mobile_phone" value="<?php echo $data['mobile_phone']?>"></td>
            </tr>
            <tr>
                <td>状态：</td>
                <td>
