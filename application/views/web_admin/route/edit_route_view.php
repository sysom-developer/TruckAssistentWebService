...
<div class="content">
    ...
    <form action="<?php echo site_url(''.$this->appfolder.'/route/act_edit_data')?>" method="post" enctype="multipart/form-data">
            ...
            <tr>
                ...
                <td>
                    <select name="start_province_id" style="width: auto;" class="sel">
                        ...
                        <?php echo $get_start_province_options?>
                    </select>
                    <select name="start_city_id" style="width: auto;" class="sel">
                        <option value="0">请选择市</option>
                        <?php echo $get_start_city_options?>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select name="end_province_id" style="width: auto;" class="sel">
                        <option value="0">请选择省</option>
                        <?php echo $get_end_province_options?>
                    </select>
                    <select name="end_city_id" style="width: auto;" class="sel">
                        <option value="0">请选择市</option>
                        <?php echo $get_end_city_options?>
                    </select>
                </td>
            </tr>
            <tr>
                <td>经过城市：</td>
                <td><input type="text" class="txt" name="route_points" value="<?php echo $data['route_points']?>"></td>
            </tr>
            <tr>
                <td>默认行驶预估时间：</td>
                <td>
                    <input type="text" class="txt" name="route_duration" value="<?php echo $data['route_duration'] / 3600?>">
            ...
            <tr>
                ...
                <td>
                    <select name="route_status" style="width: auto;">
                        <option value="1" <?php if ($data['route_status'] == 1) { echo 'selected';}?>>有效</option>
                        <option value="2" <?php if ($data['route_status'] == 2) { echo 'selected';}?>>无效</option>
                    </select>
                </td>
            </tr>
            <tr>
