...
<div class="content">
    ...
    <form action="<?php echo site_url(''.$this->appfolder.'/product_score/act_add_data')?>" method="post" enctype="multipart/form-data">
    <div class="forms_box">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td width="100">名称：</td>
                <td>
                    <input type="text" class="txt" name="product_name" value="">
                </td>
            </tr>
            <tr>
                <td>描述：</td>
            ...
            <tr>
                <td>所需积分：</td>
                <td>
                    <input type="text" class="txt" name="exchange_num" value="0">
                </td>
            </tr>
            <tr>
                <td>状态：</td>
