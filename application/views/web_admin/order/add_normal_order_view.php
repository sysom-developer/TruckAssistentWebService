...
$(function() {
    ...
    $(".add-order-submit").click(function() {
        ...
        $.post(apppath + 'order/ajax_do_normal_order', $("form[name=publish_order_form]").serialize(), function(json) {
            if (json.code == 'success') {
                alert('添加成功');
    ...
    <div class="forms_box">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td>货物数量：</td>
                <td>
                    <input name="good_nums" type="text" class="txt" value=""/>
                </td>
            </tr>
            <tr>
                <td>货物重量：</td>
                <td>
                    <input name="good_load" type="text" class="txt" value=""/>
                </td>
            </tr>
            <tr>
                <td>货物体积：</td>
                <td>
                    <input name="good_volume" type="text" class="txt" value=""/>
                </td>
            </tr>
            <tr>
                <td>发货人：</td>
            ...
            <tr>
                <td>运送价格：</td>
                <td>
                    <input name="good_freight" type="text" class="txt" value=""/>
                </td>
            </tr>
            <tr>
                <td>保证金：</td>
                <td>
                    <input name="good_margin" type="text" class="txt" value=""/>
                </td>
            </tr>
            <tr>
                <td>状态：</td>
