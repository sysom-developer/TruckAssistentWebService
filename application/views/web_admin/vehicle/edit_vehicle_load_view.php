...
<div class="content">
    ...
    <form action="<?php echo site_url(''.$this->appfolder.'/vehicle_load/act_edit_data')?>" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo $id?>">
    <div class="forms_box">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td width="100">载重（吨）：</td>
                <td>
                    <input type="text" class="txt" name="load" value="<?php echo $data['load']?>">
                </td>
            </tr>
            <tr>
                <td>状态：</td>
