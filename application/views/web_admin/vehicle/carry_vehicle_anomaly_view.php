    ...
    <div class="shop">
        <div class="shop_content">
            <div class="search_box">
                <form method="get" action="<?php echo site_url(''.$this->appfolder.'/carry_vehicle_anomaly')?>">
    ...
    <div class="table_box">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr name="data_list">
                ...
                <td><?php echo $data['order_data']['order_start_city'].'-'.$data['order_data']['order_end_city']?></td>
                <td><?php echo date('Y-m-d H:i:s', $data['order_data']['good_start_time'])?></td>
