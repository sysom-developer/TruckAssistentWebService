...
class Vehicle extends Public_Android_Controller {
    ...
    {
        $this->data['error']['body']['data_list'] = $this->vehicle_service->get_vehicle_type_data_list();
    ...
    {
        $this->data['error']['body']['data_list'] = $this->vehicle_service->get_vehicle_load_data_list();
    ...
    {
        $this->data['error']['body']['data_list'] = $this->vehicle_service->get_vehicle_length_data_list();
