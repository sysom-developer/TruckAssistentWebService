...
var popUpCal = {
    ...
    showCalendar: function() {
        ...
        if (this.timeSeparators.length > 1) {
            timeSelect += '<div id="calendar_time"><div class="select_429" style="width:37px;margin-left:55px;"><select id="calendar_hour" style="width:40px">';
            ...
            timeSelect += '</select></div><div class="select_429" style=" width:10px;">' + this.timeSeparators[1] + '</div> <div class="select_429" style="width:37px"><select id="calendar_minute" style="width:40px">';
            for (var a = 0; a <= 59; a++) {
            ...
            if (this.timeSeparators.length == 4) {
                timeSelect += ' <div class="select_429"><select id="calendar_ampm">';
        ...
        if (!this.changeMonth) {
            ...
            html += '<div class="select_429" style=" margin-left:20px;height:20px;margin-top:5px;"><select id="calendar_newMonth" style="height:20px;">';
        ...
        if (!this.changeYear) {
            ...
            html += '<div class="select_429" style="margin-left:20px;height:20px;margin-top:5px;"><select id="calendar_newYear" style="height:20px;">';
    ...
    showTime: function() {
        ...
        var timeSelect = '';
        if (this.timeSeparators.length > 1) {
            timeSelect += '<div id="calendar_time"><div class="select_429" style="width:37px;margin-left:25px;"><select id="calendar_hour" style="width:40px">';
            if (this.timeSeparators.length == 4) {
                if (this.selectedHour == 12 || this.selectedHour == 0) timeSelect += '<option value="12" selected="selected">12</option>';
                else timeSelect += '<option value="12">12</option>';
                for (var a = 1; a < 12; a++) {
